...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data){
                if(data['type'] == 'text') {
                    ...
                    $('#edit_text_msg_type').find("option[value=" + data['msg_type'] + "]").attr("selected", true);
                    if(data['sub_msg_type'] != "")
                        $('#edit_text_sub_msg_type').find("option[value=" + data['sub_msg_type'] + "]").attr("selected", true);
                    if(data['status'] == 1){
                    ...
                    $('#edit_news_msg_type').find("option[value=" + data['msg_type'] + "]").attr("selected", true);
                    if(data['sub_msg_type'] != "")
                        $('#edit_news_sub_msg_type').find("option[value=" + data['sub_msg_type'] + "]").attr("selected", true);
                    $('#edit_news_url').val(data['text_url']);
                    $('#edit_news_pic').attr('src','__ROOT__/Uploads/Picture/' + data['pic_url']);
    ...
    $('#add_file_upload').uploadify({
        ...
        'onUploadSuccess' : function(file, data, response) {
            $('#add_news_pic').attr('src','__ROOT__/Uploads/Picture/' + data);
    ...
    $('#edit_file_upload').uploadify({
        ...
        'multi':'false',
        'onUploadSuccess' : function(file, data, response) {
            $('#edit_news_pic').attr('src','__ROOT__/Uploads/Picture/' + data);
