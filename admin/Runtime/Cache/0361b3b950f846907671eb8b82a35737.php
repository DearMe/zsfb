                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="m-b-30">
                                            <a href="<?php echo U('RedPacket/add');?>" class="btn btn-primary waves-effect waves-light">添加</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable').dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo U('RedPacket/tableAJAX');?>"
    ...
    $(document).on("click","button[name='edit']",function(){
        location.href = "<?php echo U('RedPacket/edit');?>"+'&id='+$(this).attr('id');
    });
    ...
    $(document).on("click","button[name='show']",function(){
        ...
        location.href = "<?php echo U('PlayRedPacket/index');?>"+'&id='+$(this).attr('id');
    });
    ...
    $(document).on("click","button[name='del']",function(){
        ...
        sweetAlert({
                ...
                function(){
                    ...
                    location.href = "<?php echo U('RedPacket/del');?>"+'&id='+id;
